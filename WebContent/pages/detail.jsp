            ...
            <div class="productArea">
                ...
                <div class="infoArea">
                    <ul class>
                        ...
                        <!-- 7. 구매하기.장바구니 버튼 -->
                        <li>
                            <div><button class="detail_button" type="button"
                                    onclick="location.href='/pages/payments.jsp'">구매하기</button><button class="detail_button"
                                    type="button" onclick="location.href='/pages/cart.jsp'">장바구니</button></div>
                        </li>
                    </ul>
                </div>
